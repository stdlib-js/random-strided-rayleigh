...
```javascript
import rayleigh from 'https://cdn.jsdelivr.net/gh/stdlib-js/random-strided-rayleigh@v0.1.2-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { factory } from 'https://cdn.jsdelivr.net/gh/stdlib-js/random-strided-rayleigh@v0.1.2-deno/mod.js';
```
